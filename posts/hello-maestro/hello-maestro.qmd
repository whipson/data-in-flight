...
![](images/DALL·E%202024-06-24%2013.18.18%20-%20A%20very%20simple%20blueprint-style%20header%20image%20with%20a%20hand-drawn%20feel,%20focusing%20on%20music.%20Include%20only%20a%20single%20detailed%20sketch%20of%20a%20musical%20note.%20The%20bac.webp){fig-alt="Blueprint with a music note"}
...
orch_result <- run_schedule(
  schedule,
  orch_frequency = "1 day",
  check_datetime = lubridate::now(tzone = "America/Halifax")
)
```
